...
// }
    render() {
        ...
        if (viewMode == 'slider') {
            ...
            return (
                <div>
                <Header navHeader='listImages' albumName={this.props.match.params.albumName}/>
...

                        {
                            this.state.s3Data.map((element, index) => {
                                return(
                                    ...
                                    <img src={this.state.httpPrefix + encodeURIComponent(element.Key)} key={index} data-action={this.state.httpPrefix + encodeURIComponent(element.Key)} />
                                  ...
                                  this.state.s3Data.map((element, index) => {
                                      return(
                                          ...
                                          <div>
                                              ...
                                              <img src={this.state.httpPrefix + encodeURIComponent(element.Key)} key={index} />
            ...
            return (
                <li className="image-element-class">
                    <img className="image-image" src={this.state.httpPrefix + encodeURIComponent(element.Key)} />
                </li>
