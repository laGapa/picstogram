...
import { Form, FormGroup, Col, ControlLabel, FormControl, Checkbox, Button, Row, Grid } from 'react-bootstrap'
...
                    'cognito-idp.eu-west-1.amazonaws.com/eu-west-1_GGR1owL6e' : result.getIdToken().getJwtToken()
                }
            });
...
//                 userAttributes,
//                 this
//                 // console.log("Need to change password. Will be implemented soon")
//             );
//         }
    });
    ...
    render(){
        if (this.state.logIn) {
            ...
            return <Redirect to ="/ListAlbums" push={true}/>
                            ...
                            <Form horizontal onSubmit={this.handleSubmit} >
                                ...
                                <FormGroup controlId="formHorizontalEmail" >
                                    ...
                                    <ControlLabel>Email</ControlLabel>
                                        <FormControl type="email" placeholder="Email" value={this.state.email} onChange={this.updateEmail}/>
                                    </Col>
                                </FormGroup>
                ...
                console.log("logIn state (else):"+this.state.logIn)
                return(
                    <div className='logInBackground'>
                        <Header navHeader='LoggIn'/>
                        <div className='logInMain'>
